...
function sonet_review_box_content( $post ) {
    // Display code/markup goes here. Don't forget to include nonces!
    	...
    	echo '<div class="reviewfieldholder">Location: </div><input type="text" id=sonet_review_location" name=sonet_review_location" placeholder="Location" class="admininputfield"value="'.get_post_meta( $_GET[post], '_grid_review_location', true ).'"> <br/>';
}